    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.herramienta.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('fecha_adquisicion') ? 'is-invalid' : '' }}" type="text" name="fecha_adquisicion" id="fecha_adquisicion" value="{{ old('fecha_adquisicion') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('horas_para_mantenimiento') ? 'is-invalid' : '' }}" type="number" name="horas_para_mantenimiento" id="horas_para_mantenimiento" value="{{ old('horas_para_mantenimiento', '') }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('horas_acumuladas') ? 'is-invalid' : '' }}" type="number" name="horas_acumuladas" id="horas_acumuladas" value="{{ old('horas_acumuladas', '') }}" step="1">
