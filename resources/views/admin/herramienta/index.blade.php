                            ...
                            <tr data-entry-id="{{ $herramientum->id }}">
                                ...
                                <td>
                                    @if (is_numeric($herramientum->horas_acumuladas) && is_numeric($herramientum->horas_para_mantenimiento))
                                        ...
                                        @if ($restantes <= 0)
                                            <span class="badge badge-danger">¡Mantenimiento requerido!</span>
                                        @else
                                            <span class="badge badge-success">{{ $restantes }}h restantes</span>
                                        @endif
                                    @else
                                        <span class="badge badge-secondary">Datos incompletos</span>
                                    @endif
                                </td>
                                <td>
