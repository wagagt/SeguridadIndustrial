...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.reciboPago.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.recibo-pagos.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('numero_recibo') ? 'is-invalid' : '' }}" type="text" name="numero_recibo" id="numero_recibo" value="{{ old('numero_recibo', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('periodo_fin') ? 'is-invalid' : '' }}" type="text" name="periodo_fin" id="periodo_fin" value="{{ old('periodo_fin') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('salario_base') ? 'is-invalid' : '' }}" type="number" name="salario_base" id="salario_base" value="{{ old('salario_base', '') }}" step="0.01" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('horas_trabajadas') ? 'is-invalid' : '' }}" type="number" name="horas_trabajadas" id="horas_trabajadas" value="{{ old('horas_trabajadas', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('pago_horas_extras') ? 'is-invalid' : '' }}" type="number" name="pago_horas_extras" id="pago_horas_extras" value="{{ old('pago_horas_extras', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('total_bonificaciones') ? 'is-invalid' : '' }}" type="number" name="total_bonificaciones" id="total_bonificaciones" value="{{ old('total_bonificaciones', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('total_comisiones') ? 'is-invalid' : '' }}" type="number" name="total_comisiones" id="total_comisiones" value="{{ old('total_comisiones', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('otros_ingresos') ? 'is-invalid' : '' }}" type="number" name="otros_ingresos" id="otros_ingresos" value="{{ old('otros_ingresos', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('descuento_igss') ? 'is-invalid' : '' }}" type="number" name="descuento_igss" id="descuento_igss" value="{{ old('descuento_igss', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('descuento_isr') ? 'is-invalid' : '' }}" type="number" name="descuento_isr" id="descuento_isr" value="{{ old('descuento_isr', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('descuentos_prestamos') ? 'is-invalid' : '' }}" type="number" name="descuentos_prestamos" id="descuentos_prestamos" value="{{ old('descuentos_prestamos', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('descuentos_faltas_retardos') ? 'is-invalid' : '' }}" type="number" name="descuentos_faltas_retardos" id="descuentos_faltas_retardos" value="{{ old('descuentos_faltas_retardos', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('otros_descuentos') ? 'is-invalid' : '' }}" type="number" name="otros_descuentos" id="otros_descuentos" value="{{ old('otros_descuentos', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('total_ingresos') ? 'is-invalid' : '' }}" type="number" name="total_ingresos" id="total_ingresos" value="{{ old('total_ingresos', '') }}" step="0.01" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('total_deducciones') ? 'is-invalid' : '' }}" type="number" name="total_deducciones" id="total_deducciones" value="{{ old('total_deducciones', '') }}" step="0.01" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('salario_neto') ? 'is-invalid' : '' }}" type="number" name="salario_neto" id="salario_neto" value="{{ old('salario_neto', '') }}" step="0.01" required>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('metodo_pago') ? 'is-invalid' : '' }}" name="metodo_pago" id="metodo_pago" required>
                    ...
                    @foreach(App\Models\ReciboPago::METODO_PAGO_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('metodo_pago', '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('numero_cuenta') ? 'is-invalid' : '' }}" type="text" name="numero_cuenta" id="numero_cuenta" value="{{ old('numero_cuenta', '') }}">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('firma_empleado') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="firma_empleado" id="firma_empleado" value="1" {{ old('firma_empleado', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('firma_rrhh') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="firma_rrhh" id="firma_rrhh" value="1" {{ old('firma_rrhh', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('numero_contrato_laboral') ? 'is-invalid' : '' }}" type="text" name="numero_contrato_laboral" id="numero_contrato_laboral" value="{{ old('numero_contrato_laboral', '') }}">
