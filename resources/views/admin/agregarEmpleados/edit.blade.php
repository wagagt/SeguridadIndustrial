    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.agregar-empleados.update", [$agregarEmpleado->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nombre_completo') ? 'is-invalid' : '' }}" type="text" name="nombre_completo" id="nombre_completo" value="{{ old('nombre_completo', $agregarEmpleado->nombre_completo) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('numero_identificacion') ? 'is-invalid' : '' }}" type="text" name="numero_identificacion" id="numero_identificacion" value="{{ old('numero_identificacion', $agregarEmpleado->numero_identificacion) }}" required>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('cargo') ? 'is-invalid' : '' }}" name="cargo_id" id="cargo_id">
                    @foreach($cargos as $id => $entry)
                        <option value="{{ $id }}" {{ (old('cargo_id') ? old('cargo_id') : $agregarEmpleado->cargo->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
                @if($errors->has('cargo'))
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('departamento') ? 'is-invalid' : '' }}" name="departamento_id" id="departamento_id">
                    @foreach($departamentos as $id => $entry)
                        <option value="{{ $id }}" {{ (old('departamento_id') ? old('departamento_id') : $agregarEmpleado->departamento->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('codigo_seguridad_social') ? 'is-invalid' : '' }}" type="text" name="codigo_seguridad_social" id="codigo_seguridad_social" value="{{ old('codigo_seguridad_social', $agregarEmpleado->codigo_seguridad_social) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('fecha_ingreso') ? 'is-invalid' : '' }}" type="text" name="fecha_ingreso" id="fecha_ingreso" value="{{ old('fecha_ingreso', $agregarEmpleado->fecha_ingreso) }}" required>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('otros_datos_personales') ? 'is-invalid' : '' }}" name="otros_datos_personales" id="otros_datos_personales">{{ old('otros_datos_personales', $agregarEmpleado->otros_datos_personales) }}</textarea>
